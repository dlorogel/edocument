		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "eDocument",
									"targetURL": "#itorogeledocument-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"itorogeledocument-display": {
								"semanticObject": "itorogeledocument",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=it.orogel.edocument",
									"url": sap.ui.require.toUrl("it/orogel/edocument")
								}
							}
						}
					}
